...
async function refreshAll(){
  ...
  await Promise.all([loadConveyorStatus(), loadConveyorGates(), loadConveyorHistory(), loadConstructorTemplate(), loadLibraryModels(), loadWarehouseSpools(), loadTestCleanPrinters(), loadMetrics(), loadDigitalTwin(), loadROI(), loadBalancer()]);
}
