...
class JournalTests(unittest.TestCase):
    ...
    def test_routes_are_registered(self):
        ...
        self.assertEqual({("GET", "/api/assistant/agent"),
                          ...
                          ("GET", "/api/assistant/clipboard/history"),
                          ("GET", "/api/assistant/day"),
                          ("GET", "/api/assistant/files/quick-open"),
                          ("GET", "/api/assistant/files/watches"),
                          ("GET", "/api/assistant/focus/timers"),
                          ("GET", "/api/assistant/journal"),
                          ("GET", "/api/assistant/macros"),
                          ("GET", "/api/assistant/preferences"),
                          ("GET", "/api/assistant/screen/archive"),
                          ("GET", "/api/assistant/screen/find"),
                          ("GET", "/api/assistant/screen/shot"),
                          ("GET", "/api/assistant/skills"),
                          ("GET", "/api/assistant/status"),
                          ("GET", "/api/assistant/system/audio"),
                          ("GET", "/api/assistant/system/check"),
                          ("GET", "/api/assistant/system/display"),
                          ...
                          ("GET", "/api/assistant/whitelist"),
                          ("GET", "/api/assistant/window/active"),
                          ("GET", "/api/assistant/window/controls"),
                          ("GET", "/api/assistant/window/list"),
                          ("GET", "/api/assistant/window/text"),
                          ...
                          ("POST", "/api/assistant/clipboard/read"),
                          ("POST", "/api/assistant/clipboard/write"),
                          ("POST", "/api/assistant/files/watch"),
                          ("POST", "/api/assistant/focus/stop"),
                          ("POST", "/api/assistant/focus/timer"),
                          ("POST", "/api/assistant/intent"),
                          ("POST", "/api/assistant/journal"),
                          ("POST", "/api/assistant/macro"),
                          ("POST", "/api/assistant/macro/run"),
                          ("POST", "/api/assistant/phrase"),
                          ("POST", "/api/assistant/preferences"),
                          ("POST", "/api/assistant/screen/archive"),
                          ("POST", "/api/assistant/screen/archive/erase"),
                          ("POST", "/api/assistant/screen/find"),
                          ("POST", "/api/assistant/screen/find-click"),
                          ("POST", "/api/assistant/screen/region"),
                          ("POST", "/api/assistant/suggest"),
                          ("POST", "/api/assistant/system/audio"),
                          ("POST", "/api/assistant/system/autostart"),
                          ("POST", "/api/assistant/system/focus"),
                          ...
                          ("POST", "/api/assistant/voice/dictate"),
                          ("POST", "/api/assistant/voice/listen"),
                          ("POST", "/api/assistant/voice/note"),
                          ("POST", "/api/assistant/voice/profile"),
                          ("POST", "/api/assistant/voice/say"),
                          ("POST", "/api/assistant/whitelist"),
