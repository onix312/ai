...
«Отчёт сегодня картинкой» (идея Б4 из банка идей бота, ускоренная по просьбе
владельца; архив каталогов идей удалён в 18.4.1): выручка дня столбиками по часам, короткие подписи прямо в кадре,
