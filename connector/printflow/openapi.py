...
TAG_TITLES = {
    ...
    "routes_sbp": "СБП: платежи, входящие, подтверждение, возврат",
    "routes_cashier": "Касса: вход, полка, продажа, подтверждение СБП",
    "routes_bank": "Банк: поступления, сопоставление, авто-подтверждение",
    "routes_npd": "НПД: лимит года и контроль чеков",
    "routes_printers": "Принтеры: состояние каналов связи",
    "routes_ams": "Автопилот AMS: правила катушек, диагностика, журнал и раскладка",
    "routes_print": "Печать: каталог форм, стикеры, визитки, отчёт, гарантия",
