...
META: dict[str, dict] = {
    ...
    "pay_payee_name": ("documents", "Получатель платежа", {"max_len": 160}),
    "pay_payee_inn": ("documents", "ИНН получателя платежа", {"max_len": 12}),
    "pay_payee_kpp": ("documents", "КПП получателя платежа", {"max_len": 9}),
    "pay_account": ("documents", "Расчётный счёт", {"max_len": 20}),
    "pay_bank_name": ("documents", "Банк получателя", {"max_len": 100}),
    "pay_bic": ("documents", "БИК банка", {"max_len": 9}),
    "pay_corr_account": ("documents", "Корреспондентский счёт", {"max_len": 20}),
