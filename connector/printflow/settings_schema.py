...
META.update({
    ...
    "ams_push_settings": ("printers", "AMS: отправлять настройки слотов из склада", {}),
...
HINTS: dict[str, str] = {
    ...
    "ams_push_settings": "Приводить тип, цвет, бренд и температуры слота к складу (не во время печати; защита от частых повторов).",
