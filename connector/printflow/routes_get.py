...
def get_studio_status(api: Any, ctx: Ctx):
    ...
    return 200, {
        ...
        "ssdp_running": False,
        "serial": "",
        "name": str(api.db.setting("studio_gateway_name", "NOZZA-PrintFlow")
                    or "NOZZA-PrintFlow"),
        "model": "P1S",
        "dev_model": "C12",
        "version": "01.07.00.00",
        ...
        "ssdp_searches": 0,
        "ssdp_source": "",
        # VPN-перехват LAN — главная причина «код=-1» при живом шлюзе.
        "vpn_active": False,
        "vpn_intercepting": False,
        "vpn_names": "",
        "vpn_advice": "",
        "vpn_tunnels": [],
        "mqtt_connections": 0,
        ...
        "cert_san": "",
        "cert_expires": "",
        "mode": str(api.db.setting("studio_gateway_mode", "confirm") or "confirm"),
        "autostart": False,
