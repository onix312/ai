...
Эмбосс: цифры, «-», «.», «/», пробел, кириллица и латиница (растр 5×7).
"""
...
FONT_5X7 = {
    ...
    # --- латиница, заглавные (растр 5×7; строчные сводятся к ним) ---
    ...
    # --- кириллица, заглавные (растровый шрифт 5×7, нарисован вручную) ---
    "А": ["01110", "10001", "10001", "11111", "10001", "10001", "10001"],
    "Б": ["11110", "10001", "10000", "11110", "10001", "10001", "11110"],
    ...
    "И": ["10001", "10011", "10101", "11001", "10001", "10001", "10001"],
    "Й": ["01010", "00000", "10011", "10101", "11001", "10001", "10001"],
    ...
    "У": ["10001", "10001", "10001", "10001", "01110", "00100", "00100"],
    ...
    "Щ": ["10101", "10101", "10101", "10101", "10101", "11111", "11111"],
    "Ъ": ["11000", "01000", "01000", "01110", "01001", "01001", "01110"],
    "Ы": ["10001", "10001", "10001", "11001", "10101", "10011", "10001"],
...
def _glyph_pixels(char: str) -> list[tuple[int, int]]:
    ...
    if char == " ":
        return []
    rows = FONT_5X7.get(char) or FONT_5X7.get(char.upper())
    if rows is None:
        raise ValueError(f"Символ «{char}» не поддерживается — цифры, "
                         "«-», «.», «/», пробел, латиница и кириллица")
    out = []
