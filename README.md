...
2. **Откройте адрес из консоли** (`http://localhost:8080/`) или наведите камеру
...
либо соберите APK `ai.printflow.pult` — `./scripts/android-build.sh --pult`.
...
- **Пульт цеха** — `http://IP:8080/pult` (короткий адрес страницы `control.html`).
